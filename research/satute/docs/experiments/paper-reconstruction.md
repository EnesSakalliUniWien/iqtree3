...
```text
research/satute/experiments/001_paper_reconstruction/run.py
```

The paired head-to-head script for comparing formulas is:

```text
research/satute/experiments/002_relative_weighting/run.py
```
...
```text
research/satute/artifacts/releases/legacy/fig2_reduced_detail.tsv
research/satute/artifacts/releases/legacy/fig2_reduced_summary.tsv
```
...
For full EC2 execution, use `research/satute/tools/cluster/aws/run_full_head_to_head_shard.sh`
